...
namespace ViewWindow.Model
{
    ...
    public class ROIRectangle1 : ROI
	{
		...
		public ROIRectangle1()
		{
			...
			activeHandleIdx = 2;//0是左上角，1是右上角，2是右下角，3是左下角，4是中间点
        }
		...
		public override void moveByHandle(double newX, double newY)
		{
            ...
            Rectangle1Inf rect1 = new Rectangle1Inf(row1, col1, row2, col2);

            notifyCurrentRoiRectangle1(this, rect1);//鼠标一动就告诉窗体
